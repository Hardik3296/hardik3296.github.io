...
const SVGComponent = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => (
   <svg data-name="Layer 1" width={971.44} height={662} {...props} viewBox="0 0 971.44 662">
      <defs>
         <linearGradient
            id="a"
            x1={979.446}
      ...
      />
      <path
         d="M1009.774 663.178v-16.393h-81.969v75.821a15.984 15.984 0 0 0 15.984 15.984h50.001a15.984 15.984 0 0 0 15.984-15.984v-16.804a21.312 21.312 0 0 0 0-42.624zm0 34.427v-26.23a13.115 13.115 0 0 1 0 26.23z"
         transform="translate(-114.28 -119)"
         fill="url(#a)"
         opacity={0.7}
      />
      <path
         d="M892.857 546.744a19.459 19.459 0 1 0 19.459 19.46 19.459 19.459 0 0 0-19.459-19.46zm0 31.434a11.975 11.975 0 1 1 11.975-11.975 11.975 11.975 0 0 1-11.975 11.975z"
         fill="#6c63ff"
      />
      <path
         d="M892.857 546.744a19.459 19.459 0 1 0 19.459 19.46 19.459 19.459 0 0 0-19.459-19.46zm0 31.434a11.975 11.975 0 1 1 11.975-11.975 11.975 11.975 0 0 1-11.975 11.975z"
      ...
      />
      <path
         d="M818.016 531.776h74.841v74.072a9.75 9.75 0 0 1-9.75 9.75h-55.341a9.75 9.75 0 0 1-9.75-9.75v-74.072z"
         fill="#6c63ff"
      />
      ...
      <path
         d="M449.291 261.311h74.479v59.583a37.24 37.24 0 0 1-37.24 37.24 37.24 37.24 0 0 1-37.239-37.24v-59.583z"
         opacity={0.1}
      />
      <path
         d="M459.974 258.553h53.113a10.683 10.683 0 0 1 10.683 10.683v48.9a37.24 37.24 0 0 1-37.24 37.239 37.24 37.24 0 0 1-37.239-37.24v-48.9a10.683 10.683 0 0 1 10.683-10.682z"
         fill="#fda57d"
      />
      <path
         d="M449.43 289.434a107.19 107.19 0 0 0 74.478.206v-9.15h-74.479z"
         opacity={0.1}
      />
      ...
      />
      <path
         d="M410.367 83.052a61.67 61.67 0 0 1 15.285-24.862c21.002-20.757 55.422-25.14 73.08-48.806 4.239 6.567.958 16.668-6.331 19.49 16.894-.109 36.522-1.59 46.083-15.518a31.642 31.642 0 0 1-5.336 33.412c14.995.681 30.993 10.857 31.962 25.835.646 9.98-5.61 19.427-13.811 25.15s-18.121 8.35-27.886 10.502c-28.505 6.285-131.647 32.627-113.046-25.203zm183.189 105.55h-2.83l-55.063 49.02c-53.047-24.846-91.994 0-91.994 0l-57.748-47.005-5.823.732a106.75 106.75 0 0 0 213.458-2.747zm-106.911 67.82c-20.768 0-37.604-4.208-37.604-9.4s16.836-9.4 37.604-9.4 37.603 4.208 37.603 9.4-16.836 9.4-37.603 9.4z"
         fill="#72351c"
      />
      ...
      <path
         opacity={0.1}
         d="M41.163 648.529h889.115v4.49H41.163zm838.223-116.753v69.228a14.594 14.594 0 0 1-14.594 14.594h7.484a14.594 14.594 0 0 0 14.594-14.594v-69.228z"
      />
      <path
